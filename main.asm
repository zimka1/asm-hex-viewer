...
; ==========================================================================================================
;
; This program is a DOS utility that reads and displays file contents in hexadecimal format. 
; It processes command-line arguments from the PSP, 
; allowing users to specify file names and additional flags. 
; The -h flag displays a help message, while the -p flag enables paginated output. 
; In this mode, the maximum number of characters per line is 70, after which a line break occurs. 
; After 20 lines, the program pauses, displays the absolute file path, the current date and time, 
; and waits for a key press to continue.
;
; Files are processed step by step: opening, reading, and closing, with error handling implemented. 
; For optimization, the program reads data in blocks of 128 bytes and tracks the current file offset.
;
; At the beginning of each line, 
; the offset of the first byte in that line relative to the start of the file is displayed. 
; This helps the user navigate the data and locate specific positions in the file. 
; The offset is shown in decimal format before the hexadecimal values of the bytes.
;
; ==========================================================================================================
; ==========================================================================================================
